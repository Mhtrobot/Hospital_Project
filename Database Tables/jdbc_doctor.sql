...
CREATE TABLE `doctor` (
  ...
  `medicalExpertise` varchar(45) NOT NULL,
  `dayswork` varchar(45) DEFAULT NULL,
  `shiftHours` int NOT NULL,
  `careerRecord` int NOT NULL DEFAULT '0',
...
INSERT INTO `doctor` VALUES (1,'Mahdi Rahimi','male',19,'tehran','0912','@gmail','expert','sa',15,2,_binary '',4.0,1200),(2,'Matin Aliakbari','male',19,'tehran','0912','@gmail','expert','sa',15,2,_binary '',7.0,1000);
